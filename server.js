...
app.post('/api/teams', authenticateToken, async (req,res)=>{
  ...
  }catch{ res.status(500).json({error:'Failed to create team'}); }
});
...
app.get('/api/teams', authenticateToken, async (req,res)=>{
  try{
    ...
    `,[req.userId]);
    res.json({teams:rows});
  }catch(e){ res.status(500).json({error:'Failed to list teams'}); }
});
...
app.get('/api/teams/:id/members', authenticateToken, async (req,res)=>{
  ...
  }catch{ res.status(500).json({error:'Failed to list members'}); }
});
...
app.post('/api/teams/:id/availability', authenticateToken, async (req,res)=>{
  ...
  }catch{ res.status(500).json({error:'Failed to save availability'}); }
});
...
app.post('/api/availability-requests', authenticateToken, async (req,res)=>{
  ...
  }catch(e){ res.status(500).json({error:'Failed to create availability request'}); }
});
...
app.post('/api/booking-request/create', authenticateToken, async (req,res)=>{
  ...
  }catch(e){ res.status(500).json({error:'Failed to create booking request'}); }
});
...
app.get('/api/availability-requests/:token', async (req,res)=>{
  ...
  }catch{ res.status(500).json({error:'Failed to fetch availability request'}); }
});
...
app.post('/api/availability-requests/:token/submit', async (req,res)=>{
  ...
  }catch{ res.status(500).json({error:'Failed to submit availability'}); }
});
...
app.get('/api/availability-requests/:token/overlap', async (req,res)=>{
  ...
  }catch{ res.status(500).json({error:'Failed to calculate overlap'}); }
});
...
app.post('/api/availability-requests/:token/book', async (req,res)=>{
  ...
  }catch{ res.status(500).json({error:'Failed to finalize booking'}); }
});
